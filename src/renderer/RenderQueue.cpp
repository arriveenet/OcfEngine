...
{
    std::stable_sort(std::begin(m_commands[QueueGroup::GLOBALZ_NEG]), std::end(m_commands[QueueGroup::GLOBALZ_NEG]),
                        compareRenderCommand);
    std::stable_sort(std::begin(m_commands[QueueGroup::GLOBALZ_POS]), std::end(m_commands[QueueGroup::GLOBALZ_POS]),
                        compareRenderCommand);
}
